        ...
        <ul className="space-y-2 mb-6">
          {features.map((feature, index) => (
            <li key={index} className="flex items-start">
              <svg className="w-5 h-5 text-secondary-500 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const Services: React.FC = () => {
  const itSolutions = [
    ...
    },
    {
      ...
      title: "Cybersecurity",
      description: "Protect your business from evolving cyber threats with our security solutions.",
      features: [
    ...
    },
    {
      ...
      description: "Leverage the power of cloud computing for flexibility and scalability.",
      features: [
        "Cloud Migration",
  ...
  const webDevelopment = [
    {
      ...
      description: "Custom-designed websites that showcase your brand and engage visitors.",
      features: [
        "Responsive Design",
        "SEO Optimization",
    ...
    },
    {
      ...
      description: "Powerful online stores that drive sales and provide excellent user experience.",
      features: [
    ...
    },
    {
      ...
      description: "Tailored web applications that solve specific business challenges.",
      features: [
        "SaaS Applications",
        "Business Dashboards",
  ...
  const mobileDevelopment = [
    ...
    },
    {
      ...
      description: "Ongoing support to ensure your mobile app stays current and functional.",
      features: [
        "Regular Updates",
